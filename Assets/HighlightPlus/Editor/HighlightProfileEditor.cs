...
namespace HighlightPlus {
    ...
    public class HighlightProfileEditor : Editor {
        ...
        SerializedProperty outline, outlineColor, outlineColorStyle, outlineGradient, outlineGradientInLocalSpace, outlineWidth, outlineBlurPasses, outlineQuality, outlineEdgeMode, outlineEdgeThreshold, outlineDownsampling, outlineOptimalBlit, outlineVisibility, outlineIndependent, outlineContourStyle;
